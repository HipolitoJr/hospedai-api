"""
Django settings for hospedai project.
...
SECRET_KEY = 'sxw0+s)l*r-%)3$-*gon-&cqinoyfig9)bnail+j&rqpaxx&ij'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['192.168.43.10', '192.168.100.30', '10.0.20.66', '10.0.50.216', '172.16.105.239',]
